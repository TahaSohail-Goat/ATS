...
export const colors = {
  ...
  surfaceLightRaised: '#F1F5F9', // Light-mode raised/inset surface
  surfaceDark: '#080D1C', // Dark-mode card surface
  surfaceDarkRaised: '#0E1628', // Dark-mode raised/inset surface
  lineLight: '#E2E8F0', // Light-mode hairline/border
...
export const theme = {
  ...
  light: {
    ...
    ink: colors.text,
    // Slate-500 only reaches 4.4:1 against the raised light surface, so muted
    // text uses the deeper variant.
