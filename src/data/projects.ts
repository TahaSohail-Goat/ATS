...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: '2026',
    summary:
      'A study companion for Pakistani board students that answers strictly from their own syllabus, cites the exact chapter and page, and refuses honestly instead of guessing, with quizzes, mastery tracking, and a revision planner.',
    problem:
    ...
    features: [
      'Grounded Q&A with page citations from the real textbook and past-paper corpus',
      ...
      'Live per-chapter mastery and a day-by-day revision planner built around the exam date',
      'English, Urdu, and Roman Urdu support, including Urdu voice input',
      'Email sign-up with OTP verification, plus Google sign-in',
    ],
    tech: ['Next.js', 'TypeScript', 'Supabase', 'Gemini', 'Tailwind CSS', 'Groq'],
    highlights: [
    ...
    imageAlt: 'The Sabaq AI sign-in screen: a student studying beside stacked Physics, Chemistry, and Maths textbooks',
  },
  {
